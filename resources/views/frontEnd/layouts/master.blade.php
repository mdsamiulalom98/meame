                        ...
                        <div class="col-sm-12">
                            <div class="footer_inner">
                                ...
                                <div class="footer-about">
                                    ...
                                    <p><i class="fa-solid fa-envelope"></i><a href="mailto:{{$contact->hotmail}}" class="footer-hotlint">{{$contact->hotmail}}</a></p>
                                </div>
                                ...
                                <div class="footer-menu">
                                    <ul>
                                        ...
                                        <div>
                                            <div class="fb-page" data-href="{{$contact->facebook}}" data-tabs="timeline"  data-height="150" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="{{$contact->facebook}}" class="fb-xfbml-parse-ignore"><a href="{{$contact->facebook}}">Facebook</a></blockquote></div>
                                        </div>
                                    </ul>
                                </div>
                            </div>
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-9">
                            <div class="copyright">
                                <p>@copyright {{date('Y')}} all right reseved {{$generalsetting->name}} | Developed By <a href="https://websolutionit.com">Websolution IT</a></p>
                            </div>
                        </div>
                        <div class="col-sm-3">
