            ...
            <div class="col-sm-7 cust-order-1">
                <div class="cart_details table-responsive-sm">
                    <div class="card">
                        ...
                        <div class="note-option px-3 mb-2">
                            <p class="text-danger">নোট : প্রোডাক্টের কোয়ালিটি ঠিক থাকার পরেও যদি অর্ডার রিটার্ন করেন তাহলে শিপিং চার্জ প্রদান  করতে হবে। </p>
                        </div>
                    </div>
                </div>
            </div>
