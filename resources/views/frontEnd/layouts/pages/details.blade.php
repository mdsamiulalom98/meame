                                        ...
                                        <form action="{{ route('cart.store') }}" method="POST" name="formName">
                                            ...
                                            @if ($productcolors->count() > 0)
                                                        ...
                                                        <div class="size-container">
                                                            <div class="selector">
                                                                ...
                                                                <div class="selector-item" data-id="{{$key}}">
                                                                    ...
                                                                    />
                                                                    <label for="fc-option{{ $procolor->id }}" class="selector-item_label">{{ $procolor->color ? $procolor->color->colorName : '' }} 
                                                                    </label>
                                                                </div>
                                                                @endforeach
                                                            </div>
                                                ...
                                                @if ($productsizes->count() > 0)
                                                   ...
                                                   @elseif($details->stock < 1 || $details->whatsapp == 1)
                                                    <div class="stock_out details_sto">
                                                        <a href="https://api.whatsapp.com/send?phone={{$contact->whatsapp2}}" target="_blank">মেসেজ করুন </a>
                                                    </div>
                                                    @endif
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h1 class="modal-title fs-5" id="reviewModalLabel">@if (Auth::guard('customer')->user()) Write Review @else Please login first and submit review @endif</h1>
...
<script>    
    $(document).ready(function () {
        ...
        $(".indicator-item,.selector-item").on("click",function () {
