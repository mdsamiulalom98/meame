...
<div class="container-fluid">
   ...
   <div class="row justify-content-center">
    <div class="col-lg-8">
        <div class="card">
            <div class="card-body">
                <form action="{{route('admin.payment.update')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-2">
                            ...
                            <select type="text" id="method" class="form-control @error('method') is-invalid @enderror select2"  name="method" required>
                                ...
                                <option value="bKash"  @if($edit_data->method == 'bKash') selected @endif>bKash</option>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('sender') is-invalid @enderror" name="sender" value="{{ $edit_data->sender }}" id="sender" required="">
                            @error('sender')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('trx_id') is-invalid @enderror" name="trx_id" value="{{ $edit_data->trx_id }}" id="trx_id" required="">
                            @error('trx_id')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('carrier') is-invalid @enderror" name="carrier" value="{{ $edit_data->carrier }}" id="carrier">
                            @error('carrier')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('ref_id') is-invalid @enderror" name="ref_id" value="{{ $edit_data->ref_id }}" id="ref_id">
                            @error('ref_id')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            ...
                            <textarea type="text" class="form-control @error('description') is-invalid @enderror" name="description" id="description">{{ $edit_data->description }}</textarea>
                            @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
