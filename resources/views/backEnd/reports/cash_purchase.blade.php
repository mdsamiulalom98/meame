...
@section('title','Cash Purchase Reports')
@section('content')
@section('css')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">Cash Purchase Reports</h4>
            </div>
        </div>
    </div>       
    <!-- end page title --> 
                ...
                <div id="content-to-export">
                    <div class="table-responsive">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><a href="{{ route('purchase.edit', $value->invoice_id) }}">{{$value->invoice_id}}</a></td>
                         ...
                         <tfoot>
                            <tr >
                                <td colspan="8">
                                    ...
                                    <p class="text-center"><strong>Total Paid : {{$total_paid}} Tk</strong></p>
                                </td>
                            </tr>
                        </tfoot>
                        </table>
