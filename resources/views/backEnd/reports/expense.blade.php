                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <div class="form-group mb-3">
                                    <label for="warehouse_id" class="form-label">Warehouses </label>
                                    <select class="form-control select2 @error('warehouse_id') is-invalid @enderror"
                                        name="warehouse_id" value="{{ old('warehouse_id') }}">
                            ...
                            <div class="col-sm-2">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control form-select @error('category_id') is-invalid @enderror" id="category_id"
                            ...
                            <tbody>
                                ...
                                @foreach ($data as $key => $value)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('expense.edit', $value->id) }}">{{ $value->date }}</a>
                                        </td>
                                        <td>{{ $value->name }}</td>
