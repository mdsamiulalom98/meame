    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">Replace Reports</h4>
            </div>
        </div>
    </div>       
    <!-- end page title --> 
                ...
                <div id="content-to-export">
                    <div class="table-responsive">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><a href="{{route('admin.order.process',['invoice_id'=>$value->order?$value->order->invoice_id:''])}}" title="Process">{{$value->order?$value->order->invoice_id:''}}</a></td>
                         ...
                         <tfoot>
                             ...
                             <tr>
                                 <td colspan="8" class="text-center">
                                     ...
                                     <h5><strong>Total Purchase = {{$total_purchases}}</strong></h5>
                                     <h5><strong>Total Profit = {{$total_sales-$total_purchases}}</strong></h5>
                                 </td>
                             </tr>
                         </tfoot>
                        </table>
