                ...
                <form action="{{route('contact.update')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('facebook') is-invalid @enderror" name="facebook" value="{{ $edit_data->facebook }}"  id="facebook" >
                            @error('facebook')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group mb-3">
                            <label for="whatsapp2" class="form-label">Whatsapp2 (Product)</label>
                            <input type="text" class="form-control @error('whatsapp2') is-invalid @enderror" name="whatsapp2" value="{{ $edit_data->whatsapp2 }}"  id="whatsapp2" >
                            @error('whatsapp2')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
