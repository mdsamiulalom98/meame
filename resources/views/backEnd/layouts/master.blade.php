                    ...
                    <ul id="side-menu">
                        ...
                        <li>
                            ...
                            <div class="collapse" id="sidebar-orders">
                                <ul class="nav-second-level">
                                    ...
                                    <li>
                                        <a href="{{ route('order.categories.index')}}"><i
                                                data-feather="file-plus"></i> Order Category</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li>
                            ...
                            <div class="collapse" id="siebar-purchase">
                                <ul class="nav-second-level">
                                    <li>
                                        <a href="{{ route('supplier.index') }}"><i data-feather="file-plus"></i>
                                            Supplier List</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('purchase.categories.index') }}"><i data-feather="file-plus"></i>
                                            Purchase Category</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('purchase.create') }}"><i data-feather="file-plus"></i>
                                            Purchase Add</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('purchase.index') }}"><i
                                                data-feather="file-plus"></i>Purchase List</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('admin.payment.create', ['user' => 'supplier']) }}"><i
                                                data-feather="file-plus"></i> Payment Entry</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('admin.payment.index', ['user' => 'supplier']) }}"><i
                                                data-feather="file-plus"></i> Payment List</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('warehouses.index') }}"><i data-feather="file-plus"></i>
                                            Warehouse List</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('warehouses.transfers') }}"><i
                                                data-feather="file-plus"></i> Warehouse Transfers</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li>
                            <a href="#siebar-customer" data-bs-toggle="collapse">
                                <i data-feather="arrow-down-circle"></i>
                                <span> Customers </span>
                                <span class="menu-arrow"></span>
                            </a>
                            <div class="collapse" id="siebar-customer">
                                <ul class="nav-second-level">
                                    <li>
                                    ...
                                    <li>
                                        <a href="{{ route('admin.payment.create', ['user' => 'customer']) }}"><i
                                                data-feather="file-plus"></i> Payment Entry</a>
                                    </li>
                                    <li>
                        ...
                        <li>
                            <a href="#sidebar-product-asset" data-bs-toggle="collapse">
                                <i data-feather="coffee"></i>
                                <span> Asset </span>
                                <span class="menu-arrow"></span>
                            </a>
                            <div class="collapse" id="sidebar-product-asset">
                                <ul class="nav-second-level">
                                    <li>
                        ...
                        <li>
                            ...
                            <div class="collapse" id="sitebar-report">
                                <ul class="nav-second-level">
                                    <li>
                                        <a href="{{ route('purchase.reports') }}"><i data-feather="file-plus"></i>
                                            Purchase Reports</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('admin.due_paid', ['user' => 'supplier']) }}"><i
                                                data-feather="file-plus"></i> Purchase Due Paid</a>
                                    </li>
                                    ...
                                    <li>
                                        <a href="{{ route('admin.due_paid', ['user' => 'customer']) }}"><i
                                                data-feather="file-plus"></i> Sales Due Paid</a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="{{ route('admin.replace_report') }}"><i
                                                data-feather="file-plus"></i> Replace Reports</a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="{{ route('admin.asset_report') }}"><i
                                                data-feather="file-plus"></i> Asset Reports</a>
                                    </li>
                                    <li>
