...
<section class="customer-invoice ">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <a href="{{route('purchase.index')}}" class="no-print"><strong><i class="fe-arrow-left"></i> Back To Purchase</strong></a>
            </div>
            <div class="col-sm-6">
                        ...
                        <tr>
                            ...
                            <td  style="width:60%;float: left;">
                                ...
                                <div class="invoice-bar" style="background: #fff; transform: skew(36deg); width: 72%; margin-left: 182px; padding: 12px 32px; margin-top: 6px;">
                                    <p style="font-size: 15px; color: #222;font-weight:bold; transform: skew(-36deg); text-align: right; padding-right: 18px">Invoice ID : <strong>#{{$purchase->invoice_id}}</strong></p>
                                    <p style="font-size: 15px; color: #222;font-weight:bold; transform: skew(-36deg); text-align: right; padding-right: 32px">Invoice Date: <strong>{{$purchase->created_at->format('d-m-y')}}</strong></span></p>
                                </div>
                                <div class="invoice_to" style="padding-top: 20px;">
                                    ...
                                    <p style="font-size:16px;line-height:1.8;color:#222;text-align: right;">{{$purchase->supplier?$purchase->supplier->name:''}}</p>
                                    <p style="font-size:16px;line-height:1.8;color:#222;text-align: right;">{{$purchase->supplier?$purchase->supplier->phone:''}}</p>
                                    <p style="font-size:16px;line-height:1.8;color:#222;text-align: right;">{{$purchase->supplier?$purchase->supplier->address:''}}</p>
                                </div>
                            </td>
                        </tr>
                    </table>
                        ...
                        <table class="table" style="width: 300px; float: right;    margin-bottom: 30px;">
                            <tbody style="background:#f1f9f8">
                                <tr>
                                    ...
                                    <td><strong>৳{{$purchase->amount - $purchase->discount}}</strong></td>
                                </tr>
                                <tr>
                                    <td><strong>Discount(-)</strong></td>
                                    <td><strong>৳{{$purchase->discount}}</strong></td>
                                </tr>
                                <tr>
                                ...
                                <tr style="background:#4DBC60;color:#fff">
                                    ...
                                    <td><strong>৳{{$purchase->amount - ($purchase->discount + $purchase->paid)}}</strong></td>
                                </tr>
                            </tbody>
                        </table>
